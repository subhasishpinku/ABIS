...
public class Free extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (view == null) {
            view =  inflater.inflate(R.layout.activity_free,container,false);
...
//        skip.setOnClickListener(this);
        ...
        buy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((Subscription)getActivity()).setViewpager(0);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            {
                                JSONObject json_obj22 = jsonObject.getJSONObject("FREE");
                                String SUBSCRIPTION_ID = json_obj22.getString("SUBSCRIPTION_ID");
                                String NAME = json_obj22.getString("NAME");
                                String PRICE = json_obj22.getString("PRICE");
                                String DESCRIPTION = json_obj22.getString("DESCRIPTION");
                                Log.e("Details",SUBSCRIPTION_ID+" - "+NAME+" - "+PRICE+" - "+DESCRIPTION+" - "+"");
                                free.add(SUBSCRIPTION_ID);
                                free.add(NAME);
                                free.add(PRICE);
                                free.add(DESCRIPTION);
                                JSONArray FEATURES = json_obj22.getJSONArray("FEATURES");
                                Log.e("FEATURES", String.valueOf(FEATURES));
                                for(int j=0;j<FEATURES.length();j++) {
                                    JSONObject json_obj222 = FEATURES.getJSONObject(j);
                                    String NAME1 = json_obj222.getString("NAME");
                                    String DESCRIPTION1= json_obj222.getString("DESCRIPTION");
                                    Log.e("De",NAME1+" - "+DESCRIPTION1+" - "+"");
                                    free.add(DESCRIPTION1);
                                }
    ...
    public void add(ArrayList<String> free){
        int a = this.free.size();
        Log.e("a",a+"");
        Log.e("DATA", this.free +"");
        first = this.free.subList(0, 4);
        Log.e("First",first+"");
        List<String> Second = this.free.subList(4, a);
        Log.e("Second",Second+"");
        int b = Second.size();
        Log.e("b",b+"");
        if(b==1){
