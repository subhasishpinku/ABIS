...
public class Premium extends Fragment implements View.OnClickListener {
...
//        skip.setOnClickListener(this);
        ...
        buy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((Subscription)getActivity()).setViewpager(2);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            {
                                JSONObject json_obj = jsonObject.getJSONObject("PREMIUM");
                                String SUBSCRIPTION_ID = json_obj.getString("SUBSCRIPTION_ID");
                                ...
                                premium.add(SUBSCRIPTION_ID);
                                premium.add(NAME);
                                premium.add(PRICE);
                                premium.add(DESCRIPTION);
                                JSONArray FEATURES = json_obj.getJSONArray("FEATURES");
                                Log.e("FEATURES", String.valueOf(FEATURES));
                                for (int j = 0; j < FEATURES.length(); j++) {
                                    JSONObject json_obj1 = FEATURES.getJSONObject(j);
                                    String NAME1 = json_obj1.getString("NAME");
                                    String DESCRIPTION1 = json_obj1.getString("DESCRIPTION");
                                    Log.e("De", NAME1 + " - " + DESCRIPTION1 + " - " + "");
                                    premium.add(DESCRIPTION1);
                                }
                            }
                            int a = premium.size();
                            Log.e("DATA",premium+"");
                            first = premium.subList(0, 4);
                            Log.e("First",first+"");
                            List<String> Second = premium.subList(4, a);
                            Log.e("Second",Second+"");
